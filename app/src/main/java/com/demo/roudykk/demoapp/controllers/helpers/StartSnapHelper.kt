package com.demo.roudykk.demoapp.controllers.helpers
...
class StartSnapHelper : LinearSnapHelper() {
    ...
    private fun getStartView(layoutManager: RecyclerView.LayoutManager,
        ...
        if (layoutManager is LinearLayoutManager) {
            ...
            return if (helper != null && helper.getDecoratedEnd(child) >= helper.getDecoratedMeasurement(child) / 2 && helper.getDecoratedEnd(child) > 0) {
                child
            } else {
